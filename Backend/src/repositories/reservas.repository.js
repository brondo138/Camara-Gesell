...
// Verificar conflicto de horario en una cámara
...
const crearReserva = async (reserva) => {
    const { id_camara, id_usuario_solicitante, fecha, hora_inicio, hora_fin, motivo } = reserva;
    const query = `
        INSERT INTO reservas (id_camara, id_usuario_solicitante, fecha, hora_inicio, hora_fin, motivo)
        VALUES (?, ?, ?, ?, ?, ?);
    `;
